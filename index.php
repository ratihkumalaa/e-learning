        ...
        <aside class='main-sidebar'>
            <section class='sidebar'>
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
                    ...
                    <li><a href='<?= $homeurl ?>/jadwal'><i class='fas fa-calendar fa-fw  '></i> <span> Penilaian</span></a></li>
                    <li><a href='<?= $homeurl ?>/hasil'><i class='fas fa-tags fa-fw '></i> <span> Nilai</span></a></li>
                </ul><!-- /.sidebar-menu -->
            </section>
        </aside>
        ...
        <footer class='main-footer hidden-xs'>
            <div class='container'>
                <div class='pull-left hidden-xs'>
                    <strong>
                        <span id='end-sidebar'>
                            &copy; 2024 <?= APLIKASI . " v" . VERSI . " r" . REVISI ?>
                        </span>
                    </strong>
                </div>
        </footer>
