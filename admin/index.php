...
<body class='hold-transition skin-green-light fixed <?= $sidebar ?>'>
	...
	<div class='wrapper'>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						...
						<?php if ($setting['server'] == 'pusat') : ?>
							<li class=' treeview'>
								...
								<ul class='treeview-menu'>
								<li class='treeview'><a href='?pg=siswa'><i class='fas fa-angle-double-right fa-fw'></i> <span>Data Siswa</span></a></li>
						...
						<li class='treeview'><a href='?pg=registrasi'><i class="fas fa-user-clock side-menu-icon fa-fw   "></i> <span>Notifikasi</span></a></li>
						...
						<li><a href='?pg=materi'><i class="fas fa-envelope-open-text side-menu-icon fa-fw"></i> <span> Materi</span></a></li>
						<li><a href='?pg=tugas'><i class="fas fa-desktop side-menu-icon fa-fw"></i> <span>Tugas </span></a></li>
						<li><a href='?pg=nilaiujian'><i class="fas fa-file-signature side-menu-icon fa-fw"></i> <span> Nilai</span></a></li>
						...
						<!-- <li><a href='?pg=jadwal'><i class="fas fa-desktop side-menu-icon fa-fw"></i> <span> Penilaian</span></a></li> -->
						<!-- <li class='treeview'>
							...
							<ul class='treeview-menu'>
								...
								<li><a href='?pg=reset'><i class='fas fa-angle-double-right  fa-fw'></i> <span>Reset Penilaian</span></a></li>
				...
				<?php if ($pg == '') : ?>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						<div class='row'>
							...
							<div class='animated flipInX col-md-13'>
								<div class="row">
									<?php if ($setting['server'] == 'lokal') : ?>
										<div class="col-lg-12">
											<div class="small-box ">
							...
							<div class='col-md-12'>
								<div class='box box-solid'>
									<div class='box-header with-border'>
										...
										<div class='box-tools pull-right'>
											<button class='btn btn-sm btn-primary' data-toggle='modal' data-target='#tambahPK'><i class='glyphicon glyphicon-plus'></i> <span class='hidden-xs'>Tambah Jurusan </button>
										</div>
									</div><!-- /.box-header -->
									<div class='box-body'>
										<?= $info ?>
						...
						<div class='col-md-12'>
							<div class='box box-solid'>
								<div class='box-header with-border'>
									...
									<div class='box-tools pull-right'>
										<button class='btn btn-sm btn-flat btn-primary' data-toggle='modal' data-target='#tambahlevel'><i class='glyphicon glyphicon-plus'></i> <span class='hidden-xs'> Tambah Level</button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
						...
						<div class='col-md-12'>
							...
							<div class='box box-solid'>
								<div class='box-header with-border'>
									...
									<div class='box-tools pull-right'>
										<button class='btn btn-sm btn-flat btn-primary' data-toggle='modal' data-target='#tambahkelas'><i class='glyphicon glyphicon-plus'></i> <span class='hidden-xs'> Tambah Kelas</button>
									</div>
								</div><!-- /.box-header -->
								<div class='box-body'>
		...
		<footer class='main-footer hidden-xs center'>
			<div class='container'>
