                    ...
                    <div class="row" style="padding-bottom: 10px;">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control select2 kelas">
                                <?php $kelas = mysqli_query($koneksi, "select a.id_kelas from siswa a join nilai b on a.id_siswa=b.id_siswa group by a.id_kelas"); ?>
                        ...
                        <div class="col-md-3">
                            <select class="form-control select2 ujian">
                                <?php $ujian = mysqli_query($koneksi, "select a.id_mapel, a.kode, a.nama from mapel a join nilai b ON a.id_mapel=b.id_mapel group by a.id_mapel"); ?>
