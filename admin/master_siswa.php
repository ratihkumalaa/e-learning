		...
		if ($cekuser > 0) {
			...
			if ($pass1 <> $pass2) {
				...
				if ($setting['jenjang'] == 'SMK') {
					$exec = mysqli_query($koneksi, "INSERT INTO siswa (id_kelas,idpk,nis,no_peserta,nama,level,username,password) VALUES ('$id_kelas','$idpk','$nis','$no_peserta','$nama',,'$level','$username','$pass1')");
				} else {
					$exec = mysqli_query($koneksi, "INSERT INTO siswa (id_kelas,nis,no_peserta,nama,level,username,password) VALUES ('$id_kelas','$nis','$no_peserta','$nama','$level','$username','$pass1')");
				}
		...
		<div class='col-md-12'>
			<div class='box box-solid'>
				<div class='box-header with-border '>
					<h3 class='box-title'><i class="fas fa-user-friends fa-fw   "></i> Daftar siswa</h3>
	...
	if (isset($_POST['submit'])) {
		...
		if ($pass1 <> '' && $pass2 <> '') {
			if ($pass1 <> $pass2) {
				...
				if ($setting['jenjang'] == 'SMK') {
					$exec = mysqli_query($koneksi, "UPDATE siswa SET nis='$nis',no_peserta='$nopes', idpk='$idpk',id_kelas='$kelas',nama='$nama',username='$username',password='$pass1',level='$level' WHERE id_siswa='$id'");
				} else {
					$exec = mysqli_query($koneksi, "UPDATE siswa SET nis='$nis',no_peserta='$nopes', id_kelas='$kelas',nama='$nama',username='$username',password='$pass1',level='$level' WHERE id_siswa='$id'");
				}
			}
		} else {
			if ($setting['jenjang'] == 'SMK') {
				$exec = mysqli_query($koneksi, "UPDATE siswa SET nis='$nis',no_peserta='$nopes', idpk='$idpk',id_kelas='$kelas',nama='$nama',username='$username',level='$level' WHERE id_siswa='$id'");
			} else {
				$exec = mysqli_query($koneksi, "UPDATE siswa SET nis='$nis',no_peserta='$nopes', id_kelas='$kelas',nama='$nama',,username='$username',level='$level' WHERE id_siswa='$id'");
			}
		}
		jump("?pg=$pg");
	}
